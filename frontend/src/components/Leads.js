...
function createData(
  ...
  return { id, first_name, last_name, email, phone_number, business_name };
}
...
export default function EnhancedTable() {
  ...
  function handleDelete() {
    ...
    selected.forEach((id) => {
      ...
      fetch("/api/delete-lead", requestOptions).then((response) => {
        if (response.ok) {
          console.log("Lead was deleted");
        } else {
          console.log("Lead could not be deleted");
        }
      });
    });
  }
